...
exports.cmd = (command, executePath) => {
  return new Promise((resolve, reject) => {
    exec(command, { cwd: executePath }, (error, stdout, stderr) => {
      if (error !== null) { reject(stdout) } else { resolve(stdout) }
    })
  })
}
...
exports.mkdir = (dirPath) => {
  dirPath = path.resolve(process.cwd(), dirPath)
  mkdirp.sync(dirPath)
  process.stdout.write(`\x1b[2m${dirPath}\x1b[0m \u2713\n`)
}
...
exports.copyDir = (source, target) => {
  function _copy (sourcePath, targetPath) {
    if (fs.statSync(sourcePath).isDirectory()) {
      ...
      process.stdout.write(`\x1b[2m${targetPath}\x1b[0m \u2713\n`)
...
exports.writeFile = (filePath, content) => {
  ...
  process.stdout.write(`\x1b[2m${filePath}\x1b[0m \u2713\n`)
}
