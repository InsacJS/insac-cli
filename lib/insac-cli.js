...
async function execute (command, ...args) {
  return require(path.resolve(__dirname, `./commands/${command}`))(...args)
}
...
program
  ...
  .option('-t, --type <string>', 'Tipo de ruta.', 'get')
  .option('-v, --version <number>', 'Versión de la ruta (Siempre en el nivel mas alto).', '1')
...
program
  ...
  .option('-M, --module <moduleName>', 'Nombre del módulo. [Requerido si existen varios módulos]')
  .option('-t, --type <string>', 'Tipo de rutas que incluirá el recurso.', 'all')
  .option('-v, --version <number>', 'Versión del recurso.', '1')
